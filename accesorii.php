	...
	<body>
		...
		<section class="about py-lg-4 py-md-3 py-sm-3 py-3" id="about">
			<div class="container py-lg-5 py-md-5 py-sm-4 py-4">
				<h3 class="title text-center mb-lg-5 mb-md-4  mb-sm-4 mb-3">Accesorii</h3>
				<div class="row banner-below-w31">

					<?php
						$cerere="select * from techno1 where categorie='Accesorii'";
	               ...
	               while($linie = mysqli_fetch_row($rezultat)) {
					...
					<div class="privacy about">
						<?php
									...
									echo '<p> Nu exista produse in categoria accesorii</p>';
						?>
